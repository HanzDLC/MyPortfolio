            ...
            "projects": [
                {
                    ...
                    "impact": [
                        {"value": "--", "label": "Time Saved Weekly", "icon_type": "time"},
                        {"value": "--", "label": "Report Generation Speed", "icon_type": "trend"},
                        {"value": "--", "label": "Data Accuracy", "icon_type": "check"}
                    ]
                },
                {
                    "id": "excel-modal-2",
                    ...
                    "features": [],
                    "impact": [
                        {"value": "--", "label": "Hours Saved Monthly", "icon_type": "time"},
                        {"value": "--", "label": "Faster Reporting", "icon_type": "trend"},
                        {"value": "--", "label": "Error Reduction", "icon_type": "check"}
                    ]
                }
            ]
        },
